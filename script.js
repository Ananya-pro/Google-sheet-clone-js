...
function createVirtualStorage() {
    ...
    let c = id[0].charCodeAt(0) - 65;  // A -> 0;==>for columns 
    let r = id.substring(1) - 1; //for rows
...
function eventHandler(btnType, styleProperty, ifTypeStyleValue, styleValue) {
    ...
    createVirtualStorage(); //we say our updated matrix function
}
...
// Zoom In/Out:Add zoom buttons (+ and -) to the toolbar.Adjust the font size and cell size based on the zoom level.